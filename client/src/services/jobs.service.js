...
export const JOBS_CATALOG = [
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Gurugram', 'Noida', 'Mumbai', 'Udaipur', 'Jodhpur', 'Kota', 'Pune', 'Bengaluru'],
    primaryLocation: 'Jaipur & Delhi NCR',
    salaryMin: 16000,
    salaryMax: 24000,
    salaryPeriod: 'month',
    ...
    overview: 'Join leading security agency deployments across commercial complexes, IT parks, retail malls, residential societies, and industrial premises. Free uniforms and standard statutory benefits provided by employers.',
    responsibilities: [
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Gurugram', 'Noida', 'Mumbai', 'Pune', 'Bengaluru'],
    primaryLocation: 'Delhi NCR, Jaipur & Mumbai',
    salaryMin: 17000,
    salaryMax: 25000,
    salaryPeriod: 'month',
    ...
    postedDate: 'Recently Posted',
    summary: 'Dedicated female security personnel for frisking, access control, and visitor assistance at hospitals, corporate offices, schools, and malls.',
    overview: 'Specialized female security roles in safe, structured environments including international schools, female staff corporate campuses, shopping malls, and healthcare institutions. Safe commuting options and day-shift preferences available.',
    responsibilities: [
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Gurugram', 'Noida', 'Mumbai', 'Ahmedabad', 'Pune', 'Udaipur'],
    primaryLocation: 'Jaipur, Gurugram & Noida',
    salaryMin: 24000,
    salaryMax: 36000,
    salaryPeriod: 'month',
    ...
    summary: 'Lead guard shifts, conduct daily briefings, manage site attendance rosters, and coordinate emergency responses.',
    overview: 'Supervisory role overseeing on-site guard deployments, shift handover protocols, client escalation management, and site safety audits across corporate headquarters, manufacturing plants, and luxury residential complexes.',
    responsibilities: [
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Jodhpur', 'Kota', 'Udaipur', 'Lucknow', 'Mumbai'],
    primaryLocation: 'Rajasthan & North India',
    salaryMin: 26000,
    salaryMax: 40000,
    salaryPeriod: 'month',
    ...
    summary: 'Licensed armed personnel for banking institutions, jewellery vaults, cash management, and high-value cargo protection.',
    ...
    responsibilities: [
      ...
      'Escort cash-in-transit transit vehicles during intra-city routes',
    ...
    requirements: [
      'Valid Indian Arms Licence with All-India or State jurisdiction',
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Gurugram', 'Noida', 'Mumbai', 'Pune', 'Goa', 'Chandigarh'],
    primaryLocation: 'Delhi NCR, Jaipur & Mumbai',
    salaryMin: 22000,
    salaryMax: 35000,
    salaryPeriod: 'month',
    salaryDisplay: '₹22,000 – ₹35,000 / month',
    experienceRequired: '1 - 5 years in Crowd Control / Nightclub Security',
    ...
    genderEligibility: 'Male / Female',
    postedDate: 'Recently Posted',
    summary: 'Professional crowd control, VIP protection, and venue safety at high-end clubs, private events, weddings, and concerts.',
    overview: 'Immediate requirements for disciplined, well-built bouncers for luxury hospitality venues, high-profile celebrity events, exhibitions, and upscale lounges. Professional conduct and de-escalation skills mandatory.',
    responsibilities: [
    ...
    benefits: [
      ...
      'Flexible options for full-time club contracts or high-pay weekend assignments',
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Gurugram', 'Noida', 'Ahmedabad', 'Mumbai'],
    primaryLocation: 'Jaipur & Delhi NCR',
    salaryMin: 28000,
    salaryMax: 42000,
    salaryPeriod: 'month',
    ...
    summary: 'Multi-site operational management, client relationship handling, guard deployment audits, and recruitment coordination.',
    overview: 'Lead field operations across 10 to 20 client sites. Ensure 100% guard turnout, resolve site billing hours, conduct client feedback meetings, and manage emergency replacements.',
    responsibilities: [
  ...
  },
  {
    ...
    locations: ['Delhi', 'Gurugram', 'Noida', 'Mumbai', 'Jaipur', 'Chandigarh'],
    primaryLocation: 'Delhi NCR & Mumbai',
    salaryMin: 35000,
    salaryMax: 60000,
    salaryPeriod: 'month',
    ...
    summary: 'Personal Security Officer (PSO) providing close protection for business leaders, high-net-worth families, and public figures.',
    overview: 'Elite personal security role requiring tactical awareness, route reconnaissance, defensive driving coordination, and unobtrusive escort for principals.',
    responsibilities: [
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Jodhpur', 'Bikaner', 'Ajmer', 'Udaipur'],
    primaryLocation: 'Rajasthan & Delhi NCR',
    salaryMin: 25000,
    salaryMax: 38000,
    salaryPeriod: 'month',
    ...
    summary: 'Stationary and mobile armed security for retail jewelers, cash depots, and private industrial estates.',
    overview: 'Deploy with valid 12 Bore DBBL/SBBL or NPB weapon at designated high-value retail and banking sites. Prompt salary with arms maintenance allowance.',
    responsibilities: [
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Gurugram', 'Noida', 'Mumbai', 'Goa', 'Udaipur'],
    primaryLocation: 'Jaipur, Delhi NCR & Udaipur',
    salaryMin: 18000,
    salaryMax: 26000,
    salaryPeriod: 'month',
    ...
    genderEligibility: 'Male / Female',
    postedDate: 'Recently Posted',
    summary: 'Short-term and seasonal crowd management for destination weddings, trade expos, stadium concerts, and corporate summits.',
    overview: 'Great opportunity for candidates seeking high-energy event assignments in Rajasthan destination wedding palaces and Delhi NCR expo centers.',
    responsibilities: [
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Gurugram', 'Noida', 'Mumbai'],
    primaryLocation: 'Delhi NCR & Jaipur',
    salaryMin: 28000,
    salaryMax: 40000,
    salaryPeriod: 'month',
    ...
    summary: 'Perform surprise site compliance audits, weapon checks, guard biometric verification, and PSARA legal standard reviews.',
    overview: 'Ensure that all deployed security personnel adhere strictly to client service level agreements (SLAs), PSARA regulations, and agency standards.',
    responsibilities: [
  ...
  },
  {
    ...
    locations: ['Jaipur', 'Delhi', 'Gurugram', 'Noida', 'Mumbai', 'Bengaluru'],
    primaryLocation: 'Delhi NCR, Jaipur & Mumbai',
    salaryMin: 45000,
    salaryMax: 75000,
    salaryPeriod: 'month',
    ...
    genderEligibility: 'Male / Female',
    postedDate: '1 week ago',
    summary: 'Lead entire campus security operations, direct disaster response planning, manage multi-agency vendors, and interface with senior management.',
    overview: 'Senior management leadership role accountable for physical security strategy, executive protection, asset risk mitigation, and compliance across large enterprise sites.',
    responsibilities: [
