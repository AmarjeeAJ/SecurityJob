...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className={`sticky top-0 z-40 w-full transition-all duration-200 bg-white/95 backdrop-blur-md border-b border-slate-200/90 ${
          scrolled ? 'shadow-sm py-2 sm:py-2.5' : 'py-2.5 sm:py-3'
        }`}
      >
