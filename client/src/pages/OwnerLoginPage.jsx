...
export default function OwnerLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#091124] text-slate-800 flex flex-col justify-between relative selection:bg-blue-600 selection:text-white font-sans">
      ...
      <header className="relative z-20 w-full bg-[#070d1d] border-b border-white/[0.08] px-3.5 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-2">
      ...
      <main className="relative z-10 flex-1 flex flex-col lg:flex-row w-full max-w-[1600px] mx-auto">
        ...
        <div className="w-full lg:w-5/12 flex items-start justify-center pt-3 sm:pt-6 lg:pt-8 pb-6 sm:pb-8 px-3.5 sm:px-6 xl:px-8 bg-[#f8fafc] relative">
          ...
          <div className="w-full max-w-md relative z-10">
            ...
            <div className="lg:hidden mb-3 p-3 rounded-2xl bg-white border border-slate-200/90 shadow-2xs space-y-1">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-7 shadow-[0_15px_45px_-12px_rgba(15,23,42,0.08)] border border-slate-200/90 relative">
              
              {/* Header Icon & Title */}
              <div className="text-center mb-3 sm:mb-5">
                <div className="mx-auto w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-tr from-blue-600 via-blue-700 to-indigo-700 flex items-center justify-center text-white shadow-md shadow-blue-600/25 mb-2 sm:mb-2.5">
