...
function buildCandidateRow(input) {
  return {
    ...
    age: input.age,
    gender: input.gender,
    permanent_district: input.permanentDistrict,
    permanent_state: input.permanentState,
    permanent_subdivision: input.permanentSubdivision || null,
    permanent_block: input.permanentBlock || null,
    permanent_tehsil: input.permanentTehsil || null,
    permanent_village: input.permanentVillage || null,
    permanent_pincode: input.permanentPincode || null,
    permanent_address_line: input.permanentAddressLine || null,
    current_area: input.currentArea,
    current_stay_address: input.currentStayAddress || null,
    ...
    preferred_subdivision: input.preferredSubdivision || null,
    preferred_block: input.preferredBlock || null,
    preferred_tehsil: input.preferredTehsil || null,
    preferred_pincode: input.preferredPincode || null,
    preferred_address_line: input.preferredAddressLine || null,
    ...
    current_employment_status: input.currentEmploymentStatus || null,
    joining_availability: input.joiningAvailability || null,
    expected_salary: input.expectedSalary ?? null,
    shift_preference: input.shiftPreference || null,
    duty_hour_preference: input.dutyHourPreference || null,
    height_cm: input.heightCm ?? null,
    languages: input.languages || null,
    ex_serviceman: !!input.exServiceman,
    is_experienced: !!input.isExperienced,
