...
export const registerCandidateSchema = z
  .object({
    ...
    preferredState: z.string().trim().max(100).optional().or(z.literal('')),
    preferredDistrict: z.string().trim().max(100).optional().or(z.literal('')),
    preferredSubdivision: z.string().trim().max(100).optional().or(z.literal('')),
