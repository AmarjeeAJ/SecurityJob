...
const CSV_HEADERS = [
  ...
  'Age', 'Gender',
  'Permanent State', 'Permanent District', 'Permanent Subdivision', 'Permanent Block/Tehsil',
  'Permanent Village', 'Permanent Pincode', 'Permanent Address Line',
  'Current Area', 'Current Stay Address',
...
function rowToCsvValues(row) {
  return [
    ...
    row.permanent_subdivision || '',
    row.permanent_tehsil || row.permanent_block || '',
    row.permanent_village || '',
    row.permanent_pincode || '',
    row.permanent_address_line || '',
    row.current_area || '',
    row.current_stay_address || '',
    row.role_names || '',
    row.preferred_city_names || '',
    row.preferred_state || '',
    row.preferred_district || '',
    row.preferred_subdivision || '',
    row.preferred_tehsil || row.preferred_block || '',
    row.preferred_pincode || '',
